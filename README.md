...
Занести переменные
SECRET= - фразу для хэширования
SEPARATOR= - число опледеляющая часть токена передающаяся в cookies
припервом запуске:
ADMIN_EMAIL= почта админа (формат почты)
ADMIN_PASSWORD= - пароль админа (более 6 знаков)
